 ...
 * @author Arsiela
 */
public class Inventory_Model implements GRecord {
    ...
    Model_Inventory_Model poModel;
    JSONObject poJSON;

    public Inventory_Model(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Inventory_Model(foGRider);
...
//        }
    ...
    @Override
    public Model_Inventory_Model getModel() {
        return poModel;
    }
